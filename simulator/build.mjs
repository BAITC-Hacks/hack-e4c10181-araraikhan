...
const files={'/':['index.html','text/html; charset=utf-8'],'/style.css':['style.css','text/css; charset=utf-8'],'/app.mjs':['app.mjs','text/javascript; charset=utf-8'],'/engine.mjs':['engine.mjs','text/javascript; charset=utf-8']};
const assets={};for(const [url,[file,type]]of Object.entries(files))assets[url]={body:await readFile(`public/${file}`,'utf8'),type};
const engine=await readFile('public/engine.mjs','utf8');
const api=(await readFile('api.mjs','utf8')).replace(/^import .*?;\n/,'');
